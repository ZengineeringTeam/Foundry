...
public class GuiMetalAtomizer extends GuiFoundry
{
    ...
    protected void drawGuiContainerBackgroundLayer(float f, int x, int y)
    {
        ...
        displayTank(window_x, window_y, TANK_INPUT_X, TANK_INPUT_Y, TANK_HEIGHT, TANK_OVERLAY_X, TANK_OVERLAY_Y,
                te_atomizer.getTank(TileEntityMetalAtomizer.TANK_INPUT));
        displayTank(window_x, window_y, TANK_WATER_X, TANK_WATER_Y, TANK_HEIGHT, TANK_OVERLAY_X, TANK_OVERLAY_Y,
