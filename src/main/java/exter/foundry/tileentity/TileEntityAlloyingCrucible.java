...
public class TileEntityAlloyingCrucible extends TileEntityFoundry
{
    ...
    protected void updateServer()
    {
        ...
        {
            recipe = AlloyingCrucibleRecipeManager.INSTANCE.findRecipe(tanks[TANK_INPUT_A].getFluid(),
                    tanks[TANK_INPUT_B].getFluid());
            if (recipe == null)
            {
                recipe = AlloyingCrucibleRecipeManager.INSTANCE.findRecipe(tanks[TANK_INPUT_B].getFluid(),
                        tanks[TANK_INPUT_A].getFluid());
                if (recipe != null)
                {
                    reversed = true;
                }
