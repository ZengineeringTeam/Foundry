...
public class ContainerFluidHeater extends ContainerFoundry
{
    ...
    private final TileEntityFluidHeater te_tank;

    public ContainerFluidHeater(TileEntityFluidHeater tank, EntityPlayer player)
    {
        super(tank);
        te_tank = tank;
