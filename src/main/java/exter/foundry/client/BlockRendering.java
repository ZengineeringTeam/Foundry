...
public class BlockRendering
{
    ...
    {
        FoundryRegistry.BLOCKS.stream().filter(block -> block instanceof BlockFluidBase)
                .forEach(block -> mapFluidModel((BlockFluidBase) block));
    }

    public static void mapFluidModel(BlockFluidBase fluidBlock)
    {
        System.out.println(fluidBlock);
